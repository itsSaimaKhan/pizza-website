    ...
    return (
      <div className="relative min-h-screen py-6">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.istockphoto.com%2Fillustrations%2Fpizza-background&psig=AOvVaw3vxekgYR0FxnDE_HSm2uAg&ust=1736006890847000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCMiNjuL32YoDFQAAAAAdAAAAABAE')",
          }}
        ></div>
        <div className="relative z-10">
          ...
          {/* Product section */}
          <div className="max-w-6xl mx-auto p-4 grid grid-col-1 sm:grid-col-2 lg:grid-col-3 gap-8 text-red-600">
          ...
          <div className="max-6xl mx-auto mt-8">
            <button
              onClick={toggleCart}
              className="bg-blue-600 text-white py-3 px-6 rounded-md hover:bg-blue-800 transition duration-300 ease-in-out transform"
            >
                    ...
                    <div className="flex justify-between items-center mt-6 text-black">
                      ...
                      <div>
                        <button
                          ...
                          className="bg-green-600 py-3 px-8 rounded-lg text-lg shadow-md hover:bg-green-700 duration-300 ease-in-out text-white transform hover:scale-110"
                        >
                          Proceed To Checkout
                        </button>
                        ...
                        <button
                          onClick={clearCart}
                          className="bg-red-600 py-3 px-8 rounded-lg ml-4  text-lg shadow-md hover:bg-red-700 duration-300 ease-in-out text-white transform hover:scale-110"
                        >
                          Clear Cart
                        </button>
                      </div>
          ...
          {isCheckout && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 text-black">
              <div className="bg-whitep-8 rounded-lg shadow-lg w-full sm:w-96">
                <h2 className="text-4xl font-bold text-blue-600">Checkout</h2>
