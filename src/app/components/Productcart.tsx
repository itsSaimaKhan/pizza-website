...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return(
    <div className="bg-white p-4 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 ease-in-out">
      ...
      <button onClick={() => onAddToCart({id, name, price, image})} className="bg-blue-600 text-white px-4 rounded-lg text-xslg shadow-md hover:bg-blue-700 trasition duration-300 ease-in-out">
        Add To Cart
        </button>      
